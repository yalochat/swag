...
func (g *Gen) Build(config *Config) error {
	...
	g.debug.Printf("Generate swagger docs.... (Version v2)")
	...
	if err := processAsyncAPI(p, p.GetSwagger(), config); err != nil {
...
func processAsyncAPI(p *swag.Parser, swagger *v2.Swagger, config *Config) error {
...
func updateAsyncAPIInfo(asyncAPI *asyncSpec.AsyncAPI, swagger *v2.Swagger) {
...
func processAsyncAPIDefinitions(p *swag.Parser, asyncAPI *asyncSpec.AsyncAPI, swagger *v2.Swagger) error {
...
func createAsyncAPISchema(definition *v2.Schema) (map[string]interface{}, error) {
